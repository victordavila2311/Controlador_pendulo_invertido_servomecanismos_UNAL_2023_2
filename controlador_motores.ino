...
{
  /*
  delay(500); // Short delay to catch your robot
  Serial.println("10");
  delay(500);
  Serial.println("9");
  delay(500);
  ...
  */
  ...
  if(currentMicros-previousMicros>=Ts){
    ...
    //ts=100
    /*
    U1=67.61*E1-67.58*Ep1-Up1;
    U2=0.9738*E2-0.9659*Ep2-Up2;
    */
    //ts=1000
    //U1=6.777*E1-6.743*Ep1-Up1;
    //U1=8.013*E1-23.6*Ep1+23.18*Epp1-7.592*Eppp1+0.9853*Up1+0.997*Upp1-0.8982*Uppp1;
    //U1=3.777*E1-2.743*Ep1-Up1;
    U1=0.05*E1;
    //U2=0.1009*E2-0.09306*Ep2-Up2;
    U2=0.03*E2;
    //U1=0.02*E1;
    //U2=0.01*E2;
    Eppp1=Epp1;
